...
public class Dx {
    ...
    private static Format[] table = new Format[]{
        new Format(DDPF_FOURCC, D3DFMT_GLI1, DXGI_FORMAT_RG4_UNORM_GLI, 0), //FORMAT_RG4_UNORM,
        ...
        new Format(DDPF_FOURCC, D3DFMT_GLI1, DXGI_FORMAT_R5G6B5_UNORM_GLI, new int[]{0xf800, 0x07e0, 0x001f, 0x0000}), //FORMAT_R5G6B5_UNORM,
        new Format(DDPF_FOURCC, D3DFMT_R5G6B5, DXGI_FORMAT_B5G6R5_UNORM, new int[]{0xf800, 0x07e0, 0x001f, 0x0000}), //FORMAT_B5G6R5_UNORM,
        new Format(DDPF_FOURCC, D3DFMT_GLI1, DXGI_FORMAT_RGB5A1_UNORM_GLI, new int[]{0x7c00, 0x03e0, 0x001f, 0x8000}), //FORMAT_RGB5A1_UNORM,
        ...
        new Format(DDPF_RGB, D3DFMT_GLI1, DXGI_FORMAT_UNKNOWN, new int[]{0x000000FF, 0x0000FF00, 0x00FF0000, 0x00000000}), //FORMAT_RGB8_UNORM,
        ...
        new Format(DDPF_FOURCC, D3DFMT_DX10, DXGI_FORMAT_UNKNOWN, 0), //FORMAT_RGB8_SRGB,
