...
public class Dx {
    ...
    private static Format[] table = new Format[]{
        ...
        new Format(DDPF_FOURCC, D3DFMT_GLI1, DXGI_FORMAT_UNKNOWN, new int[]{0x0000FFFF, 0x00000000, 0x00000000, 0x00000000}), //FORMAT_R16_USCALED_PACK16,
        new Format(DDPF_FOURCC, D3DFMT_GLI1, DXGI_FORMAT_UNKNOWN, new int[]{0x0000FFFF, 0x00000000, 0x00000000, 0x00000000}), //FORMAT_R16_SSCALED_PACK16,
        ...
        new Format(DDPF_FOURCC, D3DFMT_GLI1, DXGI_FORMAT_UNKNOWN, new int[]{0x0000FFFF, 0xFFFF0000, 0x00000000, 0x00000000}), //FORMAT_RG16_USCALED_PACK16,
        new Format(DDPF_FOURCC, D3DFMT_GLI1, DXGI_FORMAT_UNKNOWN, new int[]{0x0000FFFF, 0xFFFF0000, 0x00000000, 0x00000000}), //FORMAT_RG16_SSCALED_PACK16,
        ...
        new Format(DDPF_FOURCC, D3DFMT_GLI1, DXGI_FORMAT_UNKNOWN, 0), //FORMAT_RGB16_UNORM_PACK16,
        new Format(DDPF_FOURCC, D3DFMT_GLI1, DXGI_FORMAT_UNKNOWN, 0), //FORMAT_RGB16_SNORM_PACK16,
        new Format(DDPF_FOURCC, D3DFMT_GLI1, DXGI_FORMAT_UNKNOWN, 0), //FORMAT_RGB16_USCALED_PACK16,
        new Format(DDPF_FOURCC, D3DFMT_GLI1, DXGI_FORMAT_UNKNOWN, 0), //FORMAT_RGB16_SSCALED_PACK16,
        new Format(DDPF_FOURCC, D3DFMT_GLI1, DXGI_FORMAT_UNKNOWN, 0), //FORMAT_RGB16_UINT_PACK16,
        new Format(DDPF_FOURCC, D3DFMT_GLI1, DXGI_FORMAT_UNKNOWN, 0), //FORMAT_RGB16_SINT_PACK16,
        new Format(DDPF_FOURCC, D3DFMT_GLI1, DXGI_FORMAT_UNKNOWN, 0), //FORMAT_RGB16_SFLOAT_PACK16,
        ...
        new Format(DDPF_FOURCC, D3DFMT_GLI1, DXGI_FORMAT_UNKNOWN, 0), //FORMAT_RGBA16_USCALED_PACK16,
        new Format(DDPF_FOURCC, D3DFMT_GLI1, DXGI_FORMAT_UNKNOWN, 0), //FORMAT_RGBA16_SSCALED_PACK16,
        ...
        new Format(DDPF_FOURCC, D3DFMT_GLI1, DXGI_FORMAT_UNKNOWN, 0), //FORMAT_S8_UINT_PACK8,
        new Format(DDPF_FOURCC, D3DFMT_GLI1, DXGI_FORMAT_UNKNOWN, 0), //FORMAT_D16_UNORM_S8_UINT_PACK32,
        ...
        new Format(DDPF_FOURCC_ALPHAPIXELS, D3DFMT_DXT1, DXGI_FORMAT_BC1_UNORM, 0), //FORMAT_RGB_DXT1_UNORM_BLOCK8,
        new Format(DDPF_FOURCC_ALPHAPIXELS, D3DFMT_DX10, DXGI_FORMAT_BC1_UNORM_SRGB, 0), //FORMAT_RGB_DXT1_SRGB_BLOCK8,
        ...
        new Format(DDPF_FOURCC_ALPHAPIXELS, D3DFMT_DX10, DXGI_FORMAT_UNKNOWN, 0), //FORMAT_RGB_ETC2_UNORM_BLOCK8,
        new Format(DDPF_FOURCC_ALPHAPIXELS, D3DFMT_DX10, DXGI_FORMAT_UNKNOWN, 0), //FORMAT_RGB_ETC2_SRGB_BLOCK8,
        new Format(DDPF_FOURCC, D3DFMT_GLI1, DXGI_FORMAT_UNKNOWN, 0), //FORMAT_RGBA_ETC2_A1_UNORM_BLOCK8,
        new Format(DDPF_FOURCC, D3DFMT_GLI1, DXGI_FORMAT_UNKNOWN, 0), //FORMAT_RGBA_ETC2_A1_SRGB_BLOCK8,
        new Format(DDPF_FOURCC, D3DFMT_GLI1, DXGI_FORMAT_UNKNOWN, 0), //FORMAT_RGBA_ETC2_UNORM_BLOCK8,
        new Format(DDPF_FOURCC, D3DFMT_GLI1, DXGI_FORMAT_UNKNOWN, 0), //FORMAT_RGBA_ETC2_SRGB_BLOCK8,
        ...
        new Format(DDPF_FOURCC, D3DFMT_POWERVR_4BPP, DXGI_FORMAT_UNKNOWN, 0), //FORMAT_RGB_PVRTC1_8X8_UNORM_BLOCK32,
        new Format(DDPF_FOURCC, D3DFMT_UNKNOWN, DXGI_FORMAT_UNKNOWN, 0), //FORMAT_RGB_PVRTC1_8X8_SRGB_BLOCK32,
        new Format(DDPF_FOURCC, D3DFMT_POWERVR_2BPP, DXGI_FORMAT_UNKNOWN, 0), //FORMAT_RGB_PVRTC1_16X8_UNORM_BLOCK32,
        new Format(DDPF_FOURCC, D3DFMT_UNKNOWN, DXGI_FORMAT_UNKNOWN, 0), //FORMAT_RGB_PVRTC1_16X8_SRGB_BLOCK32,
        new Format(DDPF_FOURCC, D3DFMT_POWERVR_4BPP, DXGI_FORMAT_UNKNOWN, 0), //FORMAT_RGBA_PVRTC1_8X8_UNORM_BLOCK32,
        new Format(DDPF_FOURCC, D3DFMT_UNKNOWN, DXGI_FORMAT_UNKNOWN, 0), //FORMAT_RGBA_PVRTC1_8X8_SRGB_BLOCK32,
        new Format(DDPF_FOURCC, D3DFMT_POWERVR_2BPP, DXGI_FORMAT_UNKNOWN, 0), //FORMAT_RGBA_PVRTC1_16X8_UNORM_BLOCK32,
        new Format(DDPF_FOURCC, D3DFMT_UNKNOWN, DXGI_FORMAT_UNKNOWN, 0), //FORMAT_RGBA_PVRTC1_16X8_SRGB_BLOCK32,
        ...
        new Format(DDPF_FOURCC_ALPHAPIXELS, D3DFMT_ETC, DXGI_FORMAT_UNKNOWN, 0), //FORMAT_RGB_ETC_UNORM_BLOCK8,
        new Format(DDPF_FOURCC_ALPHAPIXELS, D3DFMT_ATC, DXGI_FORMAT_UNKNOWN, 0), //FORMAT_RGB_ATC_UNORM_BLOCK8,
        new Format(DDPF_FOURCC_ALPHAPIXELS, D3DFMT_ATCA, DXGI_FORMAT_UNKNOWN, 0), //FORMAT_RGBA_ATC_EXPLICIT_UNORM_BLOCK16,
        new Format(DDPF_FOURCC_ALPHAPIXELS, D3DFMT_ATCI, DXGI_FORMAT_UNKNOWN, 0), //FORMAT_RGBA_ATC_INTERPOLATED_UNORM_BLOCK16,
