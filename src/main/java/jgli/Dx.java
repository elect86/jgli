...
public class Dx {
    ...
    private static Format[] table = new Format[]{
        ...
        new Format(DDPF_FOURCC, D3DFMT_GLI1, DXGI_FORMAT_RGB5A1_UNORM_GLI, new int[]{0x001f, 0x03e0, 0x7c00, 0x8000}), //FORMAT_RGB5A1_UNORM,
        ...
        new Format(DDPF_FOURCC, D3DFMT_GLI1, DXGI_FORMAT_BGR5A1_UNORM_GLI, new int[]{0x7c00, 0x03e0, 0x001f, 0x8000}), //FORMAT_A1RGB5_UNORM,
        ...
        new Format(DDPF_RGB, D3DFMT_UNKNOWN, DXGI_FORMAT_UNKNOWN, new int[]{0x000000FF, 0x0000FF00, 0x00FF0000, 0x00000000}), //FORMAT_RGB8_UNORM,
        ...
        new Format(DDPF_FOURCC, D3DFMT_UNKNOWN, DXGI_FORMAT_UNKNOWN, new int[]{0x00FF0000, 0x0000FF00, 0x000000FF, 0x00000000}), //FORMAT_BGR8_UNORM,
        ...
        new Format(DDPF_FOURCC, D3DFMT_R8G8B8, DXGI_FORMAT_B8G8R8X8_UNORM_SRGB, 0), //FORMAT_BGR8_SRGB,
        ...
        new Format(DDPF_FOURCC, D3DFMT_GLI1, DXGI_FORMAT_UNKNOWN, 0), //FORMAT_BGRA8_SNORM,
        ...
        new Format(DDPF_FOURCC, D3DFMT_GLI1, DXGI_FORMAT_UNKNOWN, 0), //FORMAT_BGRA8_UINT,
        new Format(DDPF_FOURCC, D3DFMT_GLI1, DXGI_FORMAT_UNKNOWN, 0), //FORMAT_BGRA8_SINT,
        ...
        new Format(DDPF_FOURCC, D3DFMT_GLI1, DXGI_FORMAT_UNKNOWN, new int[]{0x00FF0000, 0x0000FF00, 0x000000FF, 0xFF000000}), //FORMAT_ABGR8_UNORM,
        new Format(DDPF_FOURCC, D3DFMT_GLI1, DXGI_FORMAT_UNKNOWN, 0), //FORMAT_ABGR8_SNORM,
        ...
        new Format(DDPF_FOURCC, D3DFMT_GLI1, DXGI_FORMAT_UNKNOWN, 0), //FORMAT_ABGR8_UINT,
        new Format(DDPF_FOURCC, D3DFMT_GLI1, DXGI_FORMAT_UNKNOWN, 0), //FORMAT_ABGR8_SINT,
        new Format(DDPF_FOURCC, D3DFMT_GLI1, DXGI_FORMAT_UNKNOWN, new int[]{0x00FF0000, 0x0000FF00, 0x000000FF, 0xFF000000}), //FORMAT_ABGR8_SRGB,
        ...
        new Format(DDPF_FOURCC, D3DFMT_GLI1, DXGI_FORMAT_UNKNOWN, new int[]{0x000003FF, 0x000FFC00, 0x3FF00000, 0xC0000000}), //FORMAT_RGB10A2_SNORM_PACK32,
        new Format(DDPF_FOURCC, D3DFMT_GLI1, DXGI_FORMAT_UNKNOWN, new int[]{0x000003FF, 0x000FFC00, 0x3FF00000, 0xC0000000}), //FORMAT_RGB10A2_USCALED_PACK32,
        new Format(DDPF_FOURCC, D3DFMT_GLI1, DXGI_FORMAT_UNKNOWN, new int[]{0x000003FF, 0x000FFC00, 0x3FF00000, 0xC0000000}), //FORMAT_RGB10A2_SSCALED_PACK32,
        ...
        new Format(DDPF_FOURCC, D3DFMT_GLI1, DXGI_FORMAT_UNKNOWN, new int[]{0x000003FF, 0x000FFC00, 0x3FF00000, 0xC0000000}), //FORMAT_RGB10A2_SINT_PACK32,

        new Format(DDPF_FOURCC, D3DFMT_GLI1, DXGI_FORMAT_UNKNOWN, new int[]{0x3FF00000, 0x000FFC00, 0x000003FF, 0xC0000000}), //FORMAT_RGB10A2_UNORM_PACK32,
        new Format(DDPF_FOURCC, D3DFMT_GLI1, DXGI_FORMAT_UNKNOWN, new int[]{0x3FF00000, 0x000FFC00, 0x000003FF, 0xC0000000}), //FORMAT_RGB10A2_SNORM_PACK32,
        new Format(DDPF_FOURCC, D3DFMT_GLI1, DXGI_FORMAT_UNKNOWN, new int[]{0x3FF00000, 0x000FFC00, 0x000003FF, 0xC0000000}), //FORMAT_RGB10A2_USCALED_PACK32,
        new Format(DDPF_FOURCC, D3DFMT_GLI1, DXGI_FORMAT_UNKNOWN, new int[]{0x3FF00000, 0x000FFC00, 0x000003FF, 0xC0000000}), //FORMAT_RGB10A2_SSCALED_PACK32,
        new Format(DDPF_FOURCC, D3DFMT_GLI1, DXGI_FORMAT_UNKNOWN, new int[]{0x3FF00000, 0x000FFC00, 0x000003FF, 0xC0000000}), //FORMAT_RGB10A2_UINT_PACK32,
        new Format(DDPF_FOURCC, D3DFMT_GLI1, DXGI_FORMAT_UNKNOWN, new int[]{0x3FF00000, 0x000FFC00, 0x000003FF, 0xC0000000}), //FORMAT_RGB10A2_SINT_PACK32,
        ...
        new Format(DDPF_FOURCC, D3DFMT_UNKNOWN, DXGI_FORMAT_BC1_UNORM, 0), //FORMAT_RGB_DXT1_UNORM_BLOCK8,
        new Format(DDPF_FOURCC, D3DFMT_UNKNOWN, DXGI_FORMAT_BC1_UNORM_SRGB, 0), //FORMAT_RGB_DXT1_SRGB_BLOCK8,
        ...
        new Format(DDPF_FOURCC, D3DFMT_DX10, DXGI_FORMAT_UNKNOWN, 0), //FORMAT_RGB_ETC2_UNORM_BLOCK8,
        new Format(DDPF_FOURCC, D3DFMT_DX10, DXGI_FORMAT_UNKNOWN, 0), //FORMAT_RGB_ETC2_SRGB_BLOCK8,
        new Format(DDPF_FOURCC_ALPHAPIXELS, D3DFMT_GLI1, DXGI_FORMAT_UNKNOWN, 0), //FORMAT_RGBA_ETC2_A1_UNORM_BLOCK8,
        new Format(DDPF_FOURCC_ALPHAPIXELS, D3DFMT_GLI1, DXGI_FORMAT_UNKNOWN, 0), //FORMAT_RGBA_ETC2_A1_SRGB_BLOCK8,
