...
public class Gl {
    ...
    private static Format[] table = new Format[]{
        new Format(INTERNAL_RG4_EXT, EXTERNAL_RGBA, TYPE_UINT8_RG4_GTC), //FORMAT_R4G4_UNORM,
        new Format(INTERNAL_RGBA4, EXTERNAL_RGBA, TYPE_UINT16_RGBA4), //FORMAT_RGBA4_UNORM,
        ...
        new Format(INTERNAL_RGB5A1, EXTERNAL_RGBA, TYPE_UINT16_RGB5A1), //FORMAT_RGB5A1_UNORM,
        ...
        new Format(INTERNAL_R64F_EXT, EXTERNAL_RED, TYPE_U64), //FORMAT_R64_UINT,
        new Format(INTERNAL_R64F_EXT, EXTERNAL_RED, TYPE_I64), //FORMAT_R64_SINT,
        new Format(INTERNAL_R64F_EXT, EXTERNAL_RED, TYPE_F64), //FORMAT_R64_SFLOAT,

        new Format(INTERNAL_RG64F_EXT, EXTERNAL_RG, TYPE_U64), //FORMAT_RG64_UINT,
        new Format(INTERNAL_RG64F_EXT, EXTERNAL_RG, TYPE_I64), //FORMAT_RG64_SINT,
        new Format(INTERNAL_RG64F_EXT, EXTERNAL_RG, TYPE_F64), //FORMAT_RG64_SFLOAT,

        new Format(INTERNAL_RGB64F_EXT, EXTERNAL_RGB, TYPE_U64), //FORMAT_RGB64_UINT,
        new Format(INTERNAL_RGB64F_EXT, EXTERNAL_RGB, TYPE_I64), //FORMAT_RGB64_SINT,
        new Format(INTERNAL_RGB64F_EXT, EXTERNAL_RGB, TYPE_F64), //FORMAT_RGB64_SFLOAT,

        new Format(INTERNAL_RGBA64F_EXT, EXTERNAL_RGBA, TYPE_U64), //FORMAT_RGBA64_UINT,
        new Format(INTERNAL_RGBA64F_EXT, EXTERNAL_RGBA, TYPE_I64), //FORMAT_RGBA64_SINT,
        new Format(INTERNAL_RGBA64F_EXT, EXTERNAL_RGBA, TYPE_F64), //FORMAT_RGBA64_SFLOAT,
