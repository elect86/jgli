...
public enum Format {
    ...
    private final FormatInfo[] table = new FormatInfo[]{
        ...
        new FormatInfo(4, 1, 4, new Swizzles(SWIZZLE_RED, SWIZZLE_GREEN, SWIZZLE_BLUE, SWIZZLE_ALPHA), CAP_NORMALIZED_BIT, CAP_UNSIGNED_BIT), //FORMAT_RGBA8_UNORM_PACK32,
        new FormatInfo(4, 1, 4, new Swizzles(SWIZZLE_RED, SWIZZLE_GREEN, SWIZZLE_BLUE, SWIZZLE_ALPHA), CAP_NORMALIZED_BIT, CAP_SIGNED_BIT), //FORMAT_RGBA8_SNORM_PACK32,
        new FormatInfo(4, 1, 4, new Swizzles(SWIZZLE_RED, SWIZZLE_GREEN, SWIZZLE_BLUE, SWIZZLE_ALPHA), CAP_SCALED_BIT, CAP_UNSIGNED_BIT), //FORMAT_RGBA8_USCALED_PACK32,
        new FormatInfo(4, 1, 4, new Swizzles(SWIZZLE_RED, SWIZZLE_GREEN, SWIZZLE_BLUE, SWIZZLE_ALPHA), CAP_SCALED_BIT, CAP_SIGNED_BIT), //FORMAT_RGBA8_SSCALED_PACK32,
        new FormatInfo(4, 1, 4, new Swizzles(SWIZZLE_RED, SWIZZLE_GREEN, SWIZZLE_BLUE, SWIZZLE_ALPHA), CAP_INTEGER_BIT, CAP_UNSIGNED_BIT), //FORMAT_RGBA8_UINT_PACK32,
        new FormatInfo(4, 1, 4, new Swizzles(SWIZZLE_RED, SWIZZLE_GREEN, SWIZZLE_BLUE, SWIZZLE_ALPHA), CAP_INTEGER_BIT, CAP_SIGNED_BIT), //FORMAT_RGBA8_SINT_PACK32,
        ...
        new FormatInfo(6, 1, 3, new Swizzles(SWIZZLE_RED, SWIZZLE_GREEN, SWIZZLE_BLUE, SWIZZLE_ONE), CAP_NORMALIZED_BIT, CAP_UNSIGNED_BIT), //FORMAT_RGB16_UNORM_PACK16,
        new FormatInfo(6, 1, 3, new Swizzles(SWIZZLE_RED, SWIZZLE_GREEN, SWIZZLE_BLUE, SWIZZLE_ONE), CAP_NORMALIZED_BIT, CAP_SIGNED_BIT), //FORMAT_RGB16_SNORM_PACK16,
        ...
        new FormatInfo(6, 1, 3, new Swizzles(SWIZZLE_RED, SWIZZLE_GREEN, SWIZZLE_BLUE, SWIZZLE_ONE), CAP_INTEGER_BIT, CAP_UNSIGNED_BIT), //FORMAT_RGB16_UINT_PACK16,
        new FormatInfo(6, 1, 3, new Swizzles(SWIZZLE_RED, SWIZZLE_GREEN, SWIZZLE_BLUE, SWIZZLE_ONE), CAP_INTEGER_BIT, CAP_SIGNED_BIT), //FORMAT_RGB16_SINT_PACK16,
        new FormatInfo(6, 1, 3, new Swizzles(SWIZZLE_RED, SWIZZLE_GREEN, SWIZZLE_BLUE, SWIZZLE_ONE), CAP_FLOAT_BIT, CAP_SIGNED_BIT), //FORMAT_RGB16_SFLOAT_PACK16,
        ...
        new FormatInfo(8, 1, 1, new Swizzles(SWIZZLE_RED, SWIZZLE_ZERO, SWIZZLE_ZERO, SWIZZLE_ONE), CAP_INTEGER_BIT, CAP_UNSIGNED_BIT), //FORMAT_R64_UINT_PACK64,
        new FormatInfo(8, 1, 1, new Swizzles(SWIZZLE_RED, SWIZZLE_ZERO, SWIZZLE_ZERO, SWIZZLE_ONE), CAP_INTEGER_BIT, CAP_SIGNED_BIT), //FORMAT_R64_SINT_PACK64,
        new FormatInfo(8, 1, 1, new Swizzles(SWIZZLE_RED, SWIZZLE_ZERO, SWIZZLE_ZERO, SWIZZLE_ONE), CAP_FLOAT_BIT, CAP_SIGNED_BIT), //FORMAT_R64_SFLOAT_PACK64,

        new FormatInfo(16, 1, 2, new Swizzles(SWIZZLE_RED, SWIZZLE_GREEN, SWIZZLE_ZERO, SWIZZLE_ONE), CAP_INTEGER_BIT, CAP_UNSIGNED_BIT), //FORMAT_RG64_UINT_PACK64,
        new FormatInfo(16, 1, 2, new Swizzles(SWIZZLE_RED, SWIZZLE_GREEN, SWIZZLE_ZERO, SWIZZLE_ONE), CAP_INTEGER_BIT, CAP_SIGNED_BIT), //FORMAT_RG64_SINT_PACK64,
        new FormatInfo(16, 1, 2, new Swizzles(SWIZZLE_RED, SWIZZLE_GREEN, SWIZZLE_ZERO, SWIZZLE_ONE), CAP_FLOAT_BIT, CAP_SIGNED_BIT), //FORMAT_RG64_SFLOAT_PACK64,

        new FormatInfo(24, 1, 3, new Swizzles(SWIZZLE_RED, SWIZZLE_GREEN, SWIZZLE_BLUE, SWIZZLE_ONE), CAP_INTEGER_BIT, CAP_UNSIGNED_BIT), //FORMAT_RGB64_UINT_PACK64,
        new FormatInfo(24, 1, 3, new Swizzles(SWIZZLE_RED, SWIZZLE_GREEN, SWIZZLE_BLUE, SWIZZLE_ONE), CAP_INTEGER_BIT, CAP_SIGNED_BIT), //FORMAT_RGB64_SINT_PACK64,
        new FormatInfo(24, 1, 3, new Swizzles(SWIZZLE_RED, SWIZZLE_GREEN, SWIZZLE_BLUE, SWIZZLE_ONE), CAP_FLOAT_BIT, CAP_SIGNED_BIT), //FORMAT_RGB64_SFLOAT_PACK64,

        new FormatInfo(32, 1, 4, new Swizzles(SWIZZLE_RED, SWIZZLE_GREEN, SWIZZLE_BLUE, SWIZZLE_ALPHA), CAP_INTEGER_BIT, CAP_UNSIGNED_BIT), //FORMAT_RGBA64_UINT_PACK64,
        new FormatInfo(32, 1, 4, new Swizzles(SWIZZLE_RED, SWIZZLE_GREEN, SWIZZLE_BLUE, SWIZZLE_ALPHA), CAP_INTEGER_BIT, CAP_SIGNED_BIT), //FORMAT_RGBA64_SINT_PACK64,
        new FormatInfo(32, 1, 4, new Swizzles(SWIZZLE_RED, SWIZZLE_GREEN, SWIZZLE_BLUE, SWIZZLE_ALPHA), CAP_FLOAT_BIT, CAP_SIGNED_BIT), //FORMAT_RGBA64_SFLOAT_PACK64,
        ...
        new FormatInfo(3, 1, 2, new Swizzles(SWIZZLE_RED, SWIZZLE_GREEN, SWIZZLE_BLUE, SWIZZLE_ALPHA), CAP_DEPTH_BIT, CAP_INTEGER_BIT, CAP_STENCIL_BIT), //FORMAT_D16_UNORM_S8_UINT_PACK32,
        ...
        new FormatInfo(8, new int[]{4, 4, 1}, 3, new Swizzles(SWIZZLE_RED, SWIZZLE_GREEN, SWIZZLE_BLUE, SWIZZLE_ONE), CAP_COMPRESSED_BIT, CAP_NORMALIZED_BIT, CAP_UNSIGNED_BIT), //FORMAT_RGB_DXT1_UNORM_PACK8,
        new FormatInfo(8, new int[]{4, 4, 1}, 3, new Swizzles(SWIZZLE_RED, SWIZZLE_GREEN, SWIZZLE_BLUE, SWIZZLE_ONE), CAP_COMPRESSED_BIT, CAP_COLORSPACE_SRGB_BIT, CAP_NORMALIZED_BIT, CAP_UNSIGNED_BIT), //FORMAT_RGB_DXT1_SRGB_PACK8,
        ...
        new FormatInfo(8, new int[]{4, 4, 1}, 3, new Swizzles(SWIZZLE_RED, SWIZZLE_GREEN, SWIZZLE_BLUE, SWIZZLE_ONE), CAP_COMPRESSED_BIT, CAP_NORMALIZED_BIT, CAP_UNSIGNED_BIT), //FORMAT_RGB_ETC2_UNORM_PACK8,
        new FormatInfo(8, new int[]{4, 4, 1}, 3, new Swizzles(SWIZZLE_RED, SWIZZLE_GREEN, SWIZZLE_BLUE, SWIZZLE_ALPHA), CAP_COMPRESSED_BIT, CAP_COLORSPACE_SRGB_BIT, CAP_NORMALIZED_BIT, CAP_UNSIGNED_BIT), //FORMAT_RGB_ETC2_SRGB_PACK8,
        new FormatInfo(8, new int[]{4, 4, 1}, 4, new Swizzles(SWIZZLE_RED, SWIZZLE_GREEN, SWIZZLE_BLUE, SWIZZLE_ALPHA), CAP_COMPRESSED_BIT, CAP_NORMALIZED_BIT, CAP_UNSIGNED_BIT), //FORMAT_RGBA_ETC2_PUNCHTHROUGH_UNORM_PACK8,
        new FormatInfo(8, new int[]{4, 4, 1}, 4, new Swizzles(SWIZZLE_RED, SWIZZLE_GREEN, SWIZZLE_BLUE, SWIZZLE_ALPHA), CAP_COMPRESSED_BIT, CAP_COLORSPACE_SRGB_BIT, CAP_NORMALIZED_BIT, CAP_UNSIGNED_BIT), //FORMAT_RGBA_ETC2_PUNCHTHROUGH_SRGB_PACK8,
        new FormatInfo(16, new int[]{4, 4, 1}, 4, new Swizzles(SWIZZLE_RED, SWIZZLE_GREEN, SWIZZLE_BLUE, SWIZZLE_ALPHA), CAP_COMPRESSED_BIT, CAP_NORMALIZED_BIT, CAP_UNSIGNED_BIT), //FORMAT_RGBA_ETC2_UNORM_PACK16,
        new FormatInfo(16, new int[]{4, 4, 1}, 4, new Swizzles(SWIZZLE_RED, SWIZZLE_GREEN, SWIZZLE_BLUE, SWIZZLE_ALPHA), CAP_COMPRESSED_BIT, CAP_COLORSPACE_SRGB_BIT, CAP_NORMALIZED_BIT, CAP_UNSIGNED_BIT), //FORMAT_RGBA_ETC2_SRGB_PACK16,
        new FormatInfo(8, new int[]{4, 4, 1}, 1, new Swizzles(SWIZZLE_RED, SWIZZLE_GREEN, SWIZZLE_BLUE, SWIZZLE_ALPHA), CAP_COMPRESSED_BIT, CAP_NORMALIZED_BIT, CAP_UNSIGNED_BIT), //FORMAT_R11_EAC_UNORM_PACK8,
        new FormatInfo(8, new int[]{4, 4, 1}, 1, new Swizzles(SWIZZLE_RED, SWIZZLE_GREEN, SWIZZLE_BLUE, SWIZZLE_ALPHA), CAP_COMPRESSED_BIT, CAP_NORMALIZED_BIT, CAP_SIGNED_BIT), //FORMAT_R11_EAC_SNORM_PACK8,
        new FormatInfo(16, new int[]{4, 4, 1}, 2, new Swizzles(SWIZZLE_RED, SWIZZLE_GREEN, SWIZZLE_BLUE, SWIZZLE_ALPHA), CAP_COMPRESSED_BIT, CAP_NORMALIZED_BIT, CAP_UNSIGNED_BIT), //FORMAT_RG11_EAC_UNORM_PACK16,
        new FormatInfo(16, new int[]{4, 4, 1}, 2, new Swizzles(SWIZZLE_RED, SWIZZLE_GREEN, SWIZZLE_BLUE, SWIZZLE_ALPHA), CAP_COMPRESSED_BIT, CAP_NORMALIZED_BIT, CAP_SIGNED_BIT), //FORMAT_RG11_EAC_SNORM_PACK16,
        ...
        new FormatInfo(32, new int[]{8, 8, 1}, 3, new Swizzles(SWIZZLE_RED, SWIZZLE_GREEN, SWIZZLE_BLUE, SWIZZLE_ONE), CAP_COMPRESSED_BIT, CAP_NORMALIZED_BIT, CAP_UNSIGNED_BIT), //FORMAT_RGB_PVRTC1_8X8_UNORM_BLOCK32,
        new FormatInfo(32, new int[]{8, 8, 1}, 3, new Swizzles(SWIZZLE_RED, SWIZZLE_GREEN, SWIZZLE_BLUE, SWIZZLE_ONE), CAP_COMPRESSED_BIT, CAP_COLORSPACE_SRGB_BIT, CAP_NORMALIZED_BIT, CAP_UNSIGNED_BIT), //FORMAT_RGB_PVRTC1_8X8_SRGB_BLOCK32,
        new FormatInfo(32, new int[]{16, 8, 1}, 3, new Swizzles(SWIZZLE_RED, SWIZZLE_GREEN, SWIZZLE_BLUE, SWIZZLE_ONE), CAP_COMPRESSED_BIT, CAP_NORMALIZED_BIT, CAP_UNSIGNED_BIT), //FORMAT_RGB_PVRTC1_16X8_UNORM_BLOCK32,
        new FormatInfo(32, new int[]{16, 8, 1}, 3, new Swizzles(SWIZZLE_RED, SWIZZLE_GREEN, SWIZZLE_BLUE, SWIZZLE_ONE), CAP_COMPRESSED_BIT, CAP_COLORSPACE_SRGB_BIT, CAP_NORMALIZED_BIT, CAP_UNSIGNED_BIT), //FORMAT_RGB_PVRTC1_16X8_SRGB_BLOCK32,
        new FormatInfo(32, new int[]{8, 8, 1}, 4, new Swizzles(SWIZZLE_RED, SWIZZLE_GREEN, SWIZZLE_BLUE, SWIZZLE_ALPHA), CAP_COMPRESSED_BIT, CAP_NORMALIZED_BIT, CAP_UNSIGNED_BIT), //FORMAT_RGBA_PVRTC1_8X8_UNORM_BLOCK32,
        new FormatInfo(32, new int[]{8, 8, 1}, 4, new Swizzles(SWIZZLE_RED, SWIZZLE_GREEN, SWIZZLE_BLUE, SWIZZLE_ALPHA), CAP_COMPRESSED_BIT, CAP_COLORSPACE_SRGB_BIT, CAP_NORMALIZED_BIT, CAP_UNSIGNED_BIT), //FORMAT_RGBA_PVRTC1_8X8_SRGB_BLOCK32,
        new FormatInfo(32, new int[]{16, 8, 1}, 4, new Swizzles(SWIZZLE_RED, SWIZZLE_GREEN, SWIZZLE_BLUE, SWIZZLE_ALPHA), CAP_COMPRESSED_BIT, CAP_NORMALIZED_BIT, CAP_UNSIGNED_BIT), //FORMAT_RGBA_PVRTC1_16X8_UNORM_BLOCK32,
        new FormatInfo(32, new int[]{16, 8, 1}, 4, new Swizzles(SWIZZLE_RED, SWIZZLE_GREEN, SWIZZLE_BLUE, SWIZZLE_ALPHA), CAP_COMPRESSED_BIT, CAP_COLORSPACE_SRGB_BIT, CAP_NORMALIZED_BIT, CAP_UNSIGNED_BIT), //FORMAT_RGBA_PVRTC1_16X8_SRGB_BLOCK32,
        new FormatInfo(8, new int[]{4, 4, 1}, 4, new Swizzles(SWIZZLE_RED, SWIZZLE_GREEN, SWIZZLE_BLUE, SWIZZLE_ALPHA), CAP_COMPRESSED_BIT, CAP_NORMALIZED_BIT, CAP_UNSIGNED_BIT), //FORMAT_RGBA_PVRTC2_4X4_UNORM_BLOCK8,
        new FormatInfo(8, new int[]{4, 4, 1}, 4, new Swizzles(SWIZZLE_RED, SWIZZLE_GREEN, SWIZZLE_BLUE, SWIZZLE_ALPHA), CAP_COMPRESSED_BIT, CAP_COLORSPACE_SRGB_BIT, CAP_NORMALIZED_BIT, CAP_UNSIGNED_BIT), //FORMAT_RGBA_PVRTC2_4X4_SRGB_BLOCK8,
        new FormatInfo(8, new int[]{8, 4, 1}, 4, new Swizzles(SWIZZLE_RED, SWIZZLE_GREEN, SWIZZLE_BLUE, SWIZZLE_ALPHA), CAP_COMPRESSED_BIT, CAP_NORMALIZED_BIT, CAP_UNSIGNED_BIT), //FORMAT_RGBA_PVRTC2_8X4_UNORM_BLOCK8,
        new FormatInfo(8, new int[]{8, 4, 1}, 4, new Swizzles(SWIZZLE_RED, SWIZZLE_GREEN, SWIZZLE_BLUE, SWIZZLE_ALPHA), CAP_COMPRESSED_BIT, CAP_COLORSPACE_SRGB_BIT, CAP_NORMALIZED_BIT, CAP_UNSIGNED_BIT), //FORMAT_RGBA_PVRTC2_8X4_SRGB_BLOCK8,

        new FormatInfo(8, new int[]{4, 4, 1}, 3, new Swizzles(SWIZZLE_RED, SWIZZLE_GREEN, SWIZZLE_BLUE, SWIZZLE_ONE), CAP_COMPRESSED_BIT, CAP_NORMALIZED_BIT, CAP_UNSIGNED_BIT), //FORMAT_RGB_ETC_UNORM_BLOCK8,
        new FormatInfo(8, new int[]{4, 4, 1}, 3, new Swizzles(SWIZZLE_RED, SWIZZLE_GREEN, SWIZZLE_BLUE, SWIZZLE_ONE), CAP_COMPRESSED_BIT, CAP_NORMALIZED_BIT, CAP_UNSIGNED_BIT), //FORMAT_RGB_ATC_UNORM_BLOCK8,
        new FormatInfo(16, new int[]{4, 4, 1}, 4, new Swizzles(SWIZZLE_RED, SWIZZLE_GREEN, SWIZZLE_BLUE, SWIZZLE_ALPHA), CAP_COMPRESSED_BIT, CAP_NORMALIZED_BIT, CAP_UNSIGNED_BIT), //FORMAT_RGBA_ATC_EXPLICIT_UNORM_BLOCK16,
        new FormatInfo(16, new int[]{4, 4, 1}, 4, new Swizzles(SWIZZLE_RED, SWIZZLE_GREEN, SWIZZLE_BLUE, SWIZZLE_ALPHA), CAP_COMPRESSED_BIT, CAP_NORMALIZED_BIT, CAP_UNSIGNED_BIT), //FORMAT_RGBA_ATC_INTERPOLATED_UNORM_BLOCK16,

        new FormatInfo(1, 1, 1, new Swizzles(SWIZZLE_RED, SWIZZLE_ZERO, SWIZZLE_ZERO, SWIZZLE_ONE), CAP_NORMALIZED_BIT, CAP_UNSIGNED_BIT, CAP_LUMINANCE_ALPHA_BIT), //FORMAT_L8_UNORM_BLOCK8,
        new FormatInfo(1, 1, 1, new Swizzles(SWIZZLE_ZERO, SWIZZLE_ZERO, SWIZZLE_ZERO, SWIZZLE_RED), CAP_NORMALIZED_BIT, CAP_UNSIGNED_BIT, CAP_LUMINANCE_ALPHA_BIT), //FORMAT_A8_UNORM_BLOCK8,
        new FormatInfo(2, 1, 2, new Swizzles(SWIZZLE_RED, SWIZZLE_ZERO, SWIZZLE_ZERO, SWIZZLE_GREEN), CAP_NORMALIZED_BIT, CAP_UNSIGNED_BIT, CAP_LUMINANCE_ALPHA_BIT), //FORMAT_LA8_UNORM_BLOCK8,
        new FormatInfo(2, 1, 1, new Swizzles(SWIZZLE_RED, SWIZZLE_ZERO, SWIZZLE_ZERO, SWIZZLE_ONE), CAP_NORMALIZED_BIT, CAP_UNSIGNED_BIT, CAP_LUMINANCE_ALPHA_BIT), //FORMAT_L16_UNORM_BLOCK16,
        new FormatInfo(2, 1, 1, new Swizzles(SWIZZLE_ZERO, SWIZZLE_ZERO, SWIZZLE_ZERO, SWIZZLE_RED), CAP_NORMALIZED_BIT, CAP_UNSIGNED_BIT, CAP_LUMINANCE_ALPHA_BIT), //FORMAT_A16_UNORM_BLOCK16,
        new FormatInfo(4, 1, 2, new Swizzles(SWIZZLE_RED, SWIZZLE_ZERO, SWIZZLE_ZERO, SWIZZLE_GREEN), CAP_NORMALIZED_BIT, CAP_UNSIGNED_BIT, CAP_LUMINANCE_ALPHA_BIT), //FORMAT_LA16_UNORM_BLOCK16,
        ...
        new FormatInfo(1, 1, 3, new Swizzles(SWIZZLE_RED, SWIZZLE_GREEN, SWIZZLE_BLUE, SWIZZLE_ONE), CAP_PACKED8_BIT, CAP_NORMALIZED_BIT, CAP_UNSIGNED_BIT) //FORMAT_RG3B2_UNORM_BLOCK8,
    };
}
