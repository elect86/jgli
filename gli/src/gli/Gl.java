...
import static gli.Gl.ExternalFormat.*;
import static gli.Gl.InternalFormat.*;
import static gli.Gl.TypeFormat.*;
...
public class Gl {
    ...
    public static Target translate(gli.Target target) {
        if (Gl.Target.values().length != gli.Target.TARGET_COUNT.value) {
    ...
    public static Format translate(gli.Format format) {
        if (!format.isValid()) {
            throw new Error("format is not valid");
        }
        return table[format.value - gli.Format.FORMAT_FIRST.value];
    }

    public static Gl.Swizzles translate(gli.Swizzles swizzle) {

        if (Gl.Swizzle.values().length != gli.Swizzles.Swizzle.SWIZZLE_COUNT.value) {
    ...
    public static gli.Format find(InternalFormat internalFormat, ExternalFormat externalFormat,
            TypeFormat type) {

        for (int formatIndex = gli.Format.FORMAT_FIRST.value; formatIndex < FORMAT_COUNT.value; formatIndex++) {

            int index = formatIndex - gli.Format.FORMAT_FIRST.value;
            ...
            return gli.Format.get(formatIndex);
        }
    ...
    private static Format[] table = new Format[]{
        ...
        new Format(INTERNAL_RGB5A1, EXTERNAL_RGBA, TYPE_UINT16_A1RGB5_GTC), //FORMAT_A1RGB5_UNORM,
        ...
        new Format(INTERNAL_R8_USCALED_GTC, EXTERNAL_RED, TYPE_U8), //FORMAT_R8_USCALED,
        new Format(INTERNAL_R8_SSCALED_GTC, EXTERNAL_RED, TYPE_I8), //FORMAT_R8_SSCALED,
        ...
        new Format(INTERNAL_RG8_USCALED_GTC, EXTERNAL_RG, TYPE_U8), //FORMAT_RG8_USCALED,
        new Format(INTERNAL_RG8_SSCALED_GTC, EXTERNAL_RG, TYPE_I8), //FORMAT_RG8_SSCALED,
        ...
        new Format(INTERNAL_RGB8_USCALED_GTC, EXTERNAL_RGB, TYPE_U8), //FORMAT_RGB8_USCALED,
        new Format(INTERNAL_RGB8_SSCALED_GTC, EXTERNAL_RGB, TYPE_I8), //FORMAT_RGB8_SSCALED,
        ...
        new Format(INTERNAL_RGB8_USCALED_GTC, EXTERNAL_BGR, TYPE_U8), //FORMAT_BGR8_USCALED,
        new Format(INTERNAL_RGB8_SSCALED_GTC, EXTERNAL_BGR, TYPE_I8), //FORMAT_BGR8_SSCALED,
        ...
        new Format(INTERNAL_RGBA8_USCALED_GTC, EXTERNAL_RGBA, TYPE_U8), //FORMAT_RGBA8_USCALED,
        new Format(INTERNAL_RGBA8_SSCALED_GTC, EXTERNAL_RGBA, TYPE_I8), //FORMAT_RGBA8_SSCALED,
        ...
        new Format(INTERNAL_RGBA8_USCALED_GTC, EXTERNAL_BGRA, TYPE_U8), //FORMAT_BGRA8_USCALED,
        new Format(INTERNAL_RGBA8_SSCALED_GTC, EXTERNAL_BGRA, TYPE_I8), //FORMAT_BGRA8_SSCALED,
        ...
        new Format(INTERNAL_RGBA8_UNORM, EXTERNAL_RGBA, TYPE_UINT32_RGBA8_REV), //FORMAT_ABGR8_UNORM,
        new Format(INTERNAL_RGBA8_SNORM, EXTERNAL_RGBA, TYPE_UINT32_RGBA8_REV), //FORMAT_ABGR8_SNORM,
        new Format(INTERNAL_RGBA8_USCALED_GTC, EXTERNAL_RGBA, TYPE_UINT32_RGBA8_REV), //FORMAT_ABGR8_USCALED,
        new Format(INTERNAL_RGBA8_SSCALED_GTC, EXTERNAL_RGBA, TYPE_UINT32_RGBA8_REV), //FORMAT_ABGR8_SSCALED,
        new Format(INTERNAL_RGBA8U, EXTERNAL_RGBA_INTEGER, TYPE_UINT32_RGBA8_REV), //FORMAT_ABGR8_UINT,
        new Format(INTERNAL_RGBA8I, EXTERNAL_RGBA_INTEGER, TYPE_UINT32_RGBA8_REV), //FORMAT_ABGR8_SINT,
        new Format(INTERNAL_SRGB8_ALPHA8, EXTERNAL_RGBA, TYPE_UINT32_RGBA8_REV), //FORMAT_ABGR8_SRGB,
        ...
        new Format(INTERNAL_RGB10A2_USCALED_GTC, EXTERNAL_RGBA, TYPE_UINT32_RGB10A2_REV), //FORMAT_RGB10A2_USCALE,
        new Format(INTERNAL_RGB10A2_SSCALED_GTC, EXTERNAL_RGBA, TYPE_UINT32_RGB10A2_REV), //FORMAT_RGB10A2_SSCALE,
        ...
        new Format(INTERNAL_RGB10A2_USCALED_GTC, EXTERNAL_RGBA, TYPE_UINT32_RGB10A2), //FORMAT_BGR10A2_USCALE,
        new Format(INTERNAL_RGB10A2_SSCALED_GTC, EXTERNAL_RGBA, TYPE_UINT32_RGB10A2), //FORMAT_BGR10A2_SSCALE,
        ...
        new Format(INTERNAL_R16_USCALED_GTC, EXTERNAL_RED, TYPE_U16), //FORMAT_R16_USCALED_PACK16,
        new Format(INTERNAL_R16_SSCALED_GTC, EXTERNAL_RED, TYPE_I16), //FORMAT_R16_SSCALED_PACK16,
        ...
        new Format(INTERNAL_RG16_USCALED_GTC, EXTERNAL_RG, TYPE_U16), //FORMAT_RG16_USCALE_PACK16,
        new Format(INTERNAL_RG16_SSCALED_GTC, EXTERNAL_RG, TYPE_I16), //FORMAT_RG16_SSCALE_PACK16,
        ...
        new Format(INTERNAL_RGB16_USCALED_GTC, EXTERNAL_RGB, TYPE_U16), //FORMAT_RGB16_USCALED_PACK16,
        new Format(INTERNAL_RGB16_SSCALED_GTC, EXTERNAL_RGB, TYPE_I16), //FORMAT_RGB16_USCALED_PACK16,
        ...
        new Format(INTERNAL_RGBA16_USCALED_GTC, EXTERNAL_RGBA, TYPE_U16), //FORMAT_RGBA16_USCALED_PACK16,
        new Format(INTERNAL_RGBA16_SSCALED_GTC, EXTERNAL_RGBA, TYPE_I16), //FORMAT_RGBA16_SSCALED_PACK16,
        ...
        new Format(INTERNAL_LUMINANCE8, EXTERNAL_LUMINANCE, TYPE_U8), //FORMAT_L8_UNORM_BLOCK8,
        new Format(INTERNAL_ALPHA8, EXTERNAL_ALPHA, TYPE_U8), //FORMAT_A8_UNORM_BLOCK8,
        new Format(INTERNAL_LUMINANCE8_ALPHA8, EXTERNAL_LUMINANCE_ALPHA, TYPE_U8), //FORMAT_LA8_UNORM_BLOCK8,
        new Format(INTERNAL_LUMINANCE16, EXTERNAL_LUMINANCE, TYPE_U16), //FORMAT_L16_UNORM_BLOCK16,
        new Format(INTERNAL_ALPHA16, EXTERNAL_ALPHA, TYPE_U16), //FORMAT_A16_UNORM_BLOCK16,
        new Format(INTERNAL_LUMINANCE16_ALPHA16, EXTERNAL_LUMINANCE_ALPHA, TYPE_U16), //FORMAT_LA16_UNORM_BLOCK16,
