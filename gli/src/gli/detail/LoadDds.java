...
import gli.dx.Dx;
import static gli.dx.Dx.D3dFormat.D3DFMT_DX10;
import static gli.dx.Dx.Ddpf.*;
import static gli.dx.Dx.DxgiFormat.DXGI_FORMAT_UNKNOWN;
import static gli.Format.*;
import gli.Glm;
import static gli.Target.*;
import gli.Texture;
import static gli.detail.LoadDds.D3d10ResourceDimension.*;
import static gli.detail.LoadDds.DdsCubemapFlag.*;
import static gli.detail.LoadDds.DdsFlag.*;
import static gli.dx.Dx.D3dFormat.D3DFMT_GLI1;
...
public class LoadDds {
    ...
    private static gli.Target getTarget(DdsHeader header, DdsHeader10 header10) {
...
//    }
    ...
    public static Texture loadDds(ByteBuffer byteBuffer) throws IOException {
        ...
        gli.Format format = FORMAT_INVALID;
