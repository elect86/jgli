...
public class Storage {
    ...
    public Storage(Storage storage, gli.Format format, int[] dimensions, int layers, int faces, int levels) {
        this(format, dimensions, layers, faces, levels);

//        for()
    }

    public Storage(gli.Format format, int[] dimensions, int layers, int faces, int levels) {
