...
public class Test {
    ...
    private gli.Gl.Swizzles glSwizzles;
    ...
    private void initTexture(GL4 gl4) throws IOException {
        ...
        glFormat = gli.Gl.translate(texture.format());

        glTarget = gli.Gl.translate(texture.target());

        glSwizzles = gli.Gl.translate(texture.swizzles());
