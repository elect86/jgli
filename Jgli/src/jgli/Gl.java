...
public class Gl {
    ...
    private static Format[] table = new Format[]{
        new Format(INTERNAL_RG4_EXT, EXTERNAL_RGBA, TYPE_UINT8_RG4_EXT), //FORMAT_R4G4_UNORM,
        new Format(INTERNAL_RG4_EXT, EXTERNAL_RGBA, TYPE_UINT8_RG4_EXT), //FORMAT_R4G4_USCALED,
        new Format(INTERNAL_RGBA4, EXTERNAL_RGBA, TYPE_UINT16_RGBA4), //FORMAT_R4G4B4A4_UNORM,
        new Format(INTERNAL_RGBA4, EXTERNAL_RGBA, TYPE_UINT16_RGBA4), //FORMAT_R4G4B4A4_USCALED,
        new Format(INTERNAL_R5G6B5, EXTERNAL_RGB, TYPE_UINT16_R5G6B5), //FORMAT_R5G6B5_UNORM,
        new Format(INTERNAL_R5G6B5, EXTERNAL_RGB, TYPE_UINT16_R5G6B5), //FORMAT_R5G6B5_USCALED,
        new Format(INTERNAL_RGB5A1, EXTERNAL_RGBA, TYPE_UINT16_RGB5A1), //FORMAT_R5G5B5A1_UNORM,
        new Format(INTERNAL_RGB5A1, EXTERNAL_RGBA, TYPE_UINT16_RGB5A1), //FORMAT_R5G5B5A1_USCALED,
        ...
        new Format(INTERNAL_RGB10A2_UNORM, EXTERNAL_RGBA, TYPE_UINT32_RGB10A2), //FORMAT_RGB10A2_UNORM,
        new Format(INTERNAL_RGB10A2_SNORM_EXT, EXTERNAL_RGBA, TYPE_UINT32_RGB10A2), //FORMAT_RGB10A2_SNORM,
        new Format(INTERNAL_RGB10A2_UNORM, EXTERNAL_RGBA, TYPE_UINT32_RGB10A2), //FORMAT_RGB10A2_USCALE,
        new Format(INTERNAL_RGB10A2_SNORM_EXT, EXTERNAL_RGBA, TYPE_UINT32_RGB10A2), //FORMAT_RGB10A2_SSCALE,
        new Format(INTERNAL_RGB10A2U, EXTERNAL_RGBA_INTEGER, TYPE_UINT32_RGB10A2), //FORMAT_RGB10A2_UINT,
        new Format(INTERNAL_RGB10A2I_EXT, EXTERNAL_RGBA_INTEGER, TYPE_UINT32_RGB10A2), //FORMAT_RGB10A2_SINT,

        new Format(INTERNAL_R16_UNORM, EXTERNAL_RED, TYPE_U16), //FORMAT_R16_UNORM,
        new Format(INTERNAL_R16_SNORM, EXTERNAL_RED, TYPE_I16), //FORMAT_R16_SNORM,
        new Format(INTERNAL_R16_UNORM, EXTERNAL_RED, TYPE_U16), //FORMAT_R16_UNORM,
        new Format(INTERNAL_R16_SNORM, EXTERNAL_RED, TYPE_I16), //FORMAT_R16_SNORM,
        new Format(INTERNAL_R16U, EXTERNAL_RED_INTEGER, TYPE_U16), //FORMAT_R16_UINT,
        new Format(INTERNAL_R16I, EXTERNAL_RED_INTEGER, TYPE_I16), //FORMAT_R16_SINT,
        new Format(INTERNAL_R16F, EXTERNAL_RED, TYPE_F16), //FORMAT_R16_SFLOAT,

        new Format(INTERNAL_RG16_UNORM, EXTERNAL_RG, TYPE_U16), //FORMAT_RG16_UNORM,
        new Format(INTERNAL_RG16_SNORM, EXTERNAL_RG, TYPE_I16), //FORMAT_RG16_SNORM,
        ...
        new Format(INTERNAL_RG16U, EXTERNAL_RG_INTEGER, TYPE_U16), //FORMAT_RG16_UINT,
        new Format(INTERNAL_RG16I, EXTERNAL_RG_INTEGER, TYPE_I16), //FORMAT_RG16_SINT,
        new Format(INTERNAL_RG16F, EXTERNAL_RG, TYPE_F16), //FORMAT_RG16_SFLOAT,

        new Format(INTERNAL_RGB16_UNORM, EXTERNAL_RGB, TYPE_U16), //FORMAT_RGB16_UNORM,
        new Format(INTERNAL_RGB16_SNORM, EXTERNAL_RGB, TYPE_I16), //FORMAT_RGB16_SNORM,
        ...
        new Format(INTERNAL_RGB16U, EXTERNAL_RGB_INTEGER, TYPE_U16), //FORMAT_RGB16_UINT,
        new Format(INTERNAL_RGB16I, EXTERNAL_RGB_INTEGER, TYPE_I16), //FORMAT_RGB16_SINT,
        new Format(INTERNAL_RGB16F, EXTERNAL_RGB, TYPE_F16), //FORMAT_RGB16_SFLOAT,

        new Format(INTERNAL_RGBA16_UNORM, EXTERNAL_RGBA, TYPE_U16), //FORMAT_RGBA16_UNORM,
        new Format(INTERNAL_RGBA16_SNORM, EXTERNAL_RGBA, TYPE_I16), //FORMAT_RGBA16_SNORM,
        ...
        new Format(INTERNAL_RGBA16U, EXTERNAL_RGBA_INTEGER, TYPE_U16), //FORMAT_RGBA16_UINT,
        new Format(INTERNAL_RGBA16I, EXTERNAL_RGBA_INTEGER, TYPE_I16), //FORMAT_RGBA16_SINT,
        new Format(INTERNAL_RGBA16F, EXTERNAL_RGBA, TYPE_F16), //FORMAT_RGBA16_SFLOAT,

        new Format(INTERNAL_R32U, EXTERNAL_RED_INTEGER, TYPE_U32), //FORMAT_R32_UINT,
        new Format(INTERNAL_R32I, EXTERNAL_RED_INTEGER, TYPE_I32), //FORMAT_R32_SINT,
        new Format(INTERNAL_R32F, EXTERNAL_RED, TYPE_F32), //FORMAT_R32_SFLOAT,

        new Format(INTERNAL_RG32U, EXTERNAL_RG_INTEGER, TYPE_U32), //FORMAT_RG32_UINT,
        new Format(INTERNAL_RG32I, EXTERNAL_RG_INTEGER, TYPE_I32), //FORMAT_RG32_SINT,
        new Format(INTERNAL_RG32F, EXTERNAL_RG, TYPE_F32), //FORMAT_RG32_SFLOAT,

        new Format(INTERNAL_RGB32U, EXTERNAL_RGB_INTEGER, TYPE_U32), //FORMAT_RGB32_UINT,
        new Format(INTERNAL_RGB32I, EXTERNAL_RGB_INTEGER, TYPE_I32), //FORMAT_RGB32_SINT,
        new Format(INTERNAL_RGB32F, EXTERNAL_RGB, TYPE_F32), //FORMAT_RGB32_SFLOAT,

        new Format(INTERNAL_RGBA32U, EXTERNAL_RGBA_INTEGER, TYPE_U32), //FORMAT_RGBA32_UINT,
        new Format(INTERNAL_RGBA32I, EXTERNAL_RGBA_INTEGER, TYPE_I32), //FORMAT_RGBA32_SINT,
        new Format(INTERNAL_RGBA32F, EXTERNAL_RGBA, TYPE_F32), //FORMAT_RGBA32_SFLOAT,

        new Format(INTERNAL_R64F_EXT, EXTERNAL_RED, TYPE_F64_EXT), //FORMAT_R64_SFLOAT,
        new Format(INTERNAL_RG64F_EXT, EXTERNAL_RG, TYPE_F64_EXT), //FORMAT_RG64_SFLOAT,
        new Format(INTERNAL_RGB64F_EXT, EXTERNAL_RGB, TYPE_F64_EXT), //FORMAT_RGB64_SFLOAT,
        new Format(INTERNAL_RGBA64F_EXT, EXTERNAL_RGBA, TYPE_F64_EXT), //FORMAT_RGBA64_SFLOAT,

        new Format(INTERNAL_RG11B10F, EXTERNAL_RGB, TYPE_UINT32_RG11B10F), //FORMAT_RG11B10_UFLOAT,
        new Format(INTERNAL_RGB9E5, EXTERNAL_RGB, TYPE_UINT32_RGB9_E5), //FORMAT_RGB9E5_UFLOAT,

        new Format(INTERNAL_D16, EXTERNAL_DEPTH, TYPE_NONE), //FORMAT_D16_UNORM,
        ...
        new Format(INTERNAL_D16S8_EXT, EXTERNAL_DEPTH, TYPE_NONE), //FORMAT_D16_UNORM_S8_UINT,
        new Format(INTERNAL_D24S8, EXTERNAL_DEPTH_STENCIL, TYPE_NONE), //FORMAT_D24_UNORM_S8_UINT,
        new Format(INTERNAL_D32FS8X24, EXTERNAL_DEPTH_STENCIL, TYPE_NONE), //FORMAT_D32_SFLOAT_S8_UINT,

        new Format(INTERNAL_RGB_DXT1, EXTERNAL_NONE, TYPE_NONE), //FORMAT_RGB_DXT1_UNORM,
        new Format(INTERNAL_SRGB_DXT1, EXTERNAL_NONE, TYPE_NONE), //FORMAT_RGB_DXT1_SRGB,
        new Format(INTERNAL_RGBA_DXT1, EXTERNAL_NONE, TYPE_NONE), //FORMAT_RGBA_DXT1_UNORM,
        new Format(INTERNAL_SRGB_ALPHA_DXT1, EXTERNAL_NONE, TYPE_NONE), //FORMAT_RGBA_DXT1_SRGB,
        new Format(INTERNAL_RGBA_DXT3, EXTERNAL_NONE, TYPE_NONE), //FORMAT_RGBA_DXT3_UNORM,
        new Format(INTERNAL_SRGB_ALPHA_DXT3, EXTERNAL_NONE, TYPE_NONE), //FORMAT_RGBA_DXT3_SRGB,
        new Format(INTERNAL_RGBA_DXT5, EXTERNAL_NONE, TYPE_NONE), //FORMAT_RGBA_DXT5_UNORM,
        new Format(INTERNAL_SRGB_ALPHA_DXT5, EXTERNAL_NONE, TYPE_NONE), //FORMAT_RGBA_DXT5_SRGB,
        new Format(INTERNAL_R_ATI1N_UNORM, EXTERNAL_NONE, TYPE_NONE), //FORMAT_R_ATI1N_UNORM,
        new Format(INTERNAL_R_ATI1N_SNORM, EXTERNAL_NONE, TYPE_NONE), //FORMAT_R_ATI1N_SNORM,
        new Format(INTERNAL_RG_ATI2N_UNORM, EXTERNAL_NONE, TYPE_NONE), //FORMAT_RG_ATI2N_UNORM,
        new Format(INTERNAL_RG_ATI2N_SNORM, EXTERNAL_NONE, TYPE_NONE), //FORMAT_RG_ATI2N_SNORM,
        new Format(INTERNAL_RGB_BP_UNSIGNED_FLOAT, EXTERNAL_NONE, TYPE_NONE), //FORMAT_RGB_BP_UFLOAT,
        new Format(INTERNAL_RGB_BP_SIGNED_FLOAT, EXTERNAL_NONE, TYPE_NONE), //FORMAT_RGB_BP_SFLOAT,
        ...
        new Format(INTERNAL_RGB_ETC2, EXTERNAL_NONE, TYPE_NONE), //FORMAT_RGB_ETC2_UNORM,
        new Format(INTERNAL_SRGB8_ETC2, EXTERNAL_NONE, TYPE_NONE), //FORMAT_RGB_ETC2_SRGB,
        ...
        new Format(INTERNAL_RGBA_ETC2, EXTERNAL_NONE, TYPE_NONE), //FORMAT_RGBA_ETC2_UNORM,
        new Format(INTERNAL_SRGB8_ALPHA8_ETC2_EAC, EXTERNAL_NONE, TYPE_NONE), //FORMAT_RGBA_ETC2_SRGB,
        ...
        new Format(INTERNAL_RGBA4, EXTERNAL_BGRA, TYPE_UINT16_RGBA4), //FORMAT_BGRA4_UNORM,
        new Format(INTERNAL_RGBA4, EXTERNAL_BGRA, TYPE_UINT16_RGBA4), //FORMAT_BGRA4_USCALED,
        new Format(INTERNAL_R5G6B5, EXTERNAL_BGR, TYPE_UINT16_R5G6B5), //FORMAT_B5G6R5_UNORM,
        new Format(INTERNAL_R5G6B5, EXTERNAL_BGR, TYPE_UINT16_R5G6B5), //FORMAT_B5G6R5_USCALED,
        new Format(INTERNAL_RGB5A1, EXTERNAL_BGRA, TYPE_UINT16_RGB5A1), //FORMAT_BGR5A1_UNORM,
        new Format(INTERNAL_RGB5A1, EXTERNAL_BGRA, TYPE_UINT16_RGB5A1), //FORMAT_BGRA1_USCALED,
        ...
        new Format(INTERNAL_RG3B2, EXTERNAL_RGB, TYPE_UINT8_RG3B2), //FORMAT_RG3B2_UNORM,
        ...
        new Format(INTERNAL_R8_UNORM, EXTERNAL_RED, TYPE_U8), //FORMAT_L8_UNORM,
        new Format(INTERNAL_R8_UNORM, EXTERNAL_RED, TYPE_U8), //FORMAT_A8_UNORM,
        new Format(INTERNAL_RG8_UNORM, EXTERNAL_RG, TYPE_U8), //FORMAT_LA8_UNORM,
        new Format(INTERNAL_R16_UNORM, EXTERNAL_RED, TYPE_U16), //FORMAT_L16_UNORM,
        new Format(INTERNAL_R16_UNORM, EXTERNAL_RED, TYPE_U16), //FORMAT_A16_UNORM,
        new Format(INTERNAL_RG16_UNORM, EXTERNAL_RG, TYPE_U16), //FORMAT_LA16_UNORM,

        new Format(INTERNAL_RGB_PVRTC_4BPPV1, EXTERNAL_NONE, TYPE_NONE), //FORMAT_RGB_PVRTC1_8X8_UNORM,
        new Format(INTERNAL_SRGB_PVRTC_2BPPV1, EXTERNAL_NONE, TYPE_NONE), //FORMAT_RGB_PVRTC1_8X8_SRGB,
        new Format(INTERNAL_RGB_PVRTC_2BPPV1, EXTERNAL_NONE, TYPE_NONE), //FORMAT_RGB_PVRTC1_16X8_UNORM,
        new Format(INTERNAL_SRGB_PVRTC_4BPPV1, EXTERNAL_NONE, TYPE_NONE), //FORMAT_RGB_PVRTC1_16X8_SRGB,
        new Format(INTERNAL_RGBA_PVRTC_4BPPV1, EXTERNAL_NONE, TYPE_NONE), //FORMAT_RGBA_PVRTC1_8X8_UNORM,
        new Format(INTERNAL_SRGB_ALPHA_PVRTC_2BPPV1, EXTERNAL_NONE, TYPE_NONE), //FORMAT_RGBA_PVRTC1_8X8_SRGB,
        new Format(INTERNAL_RGBA_PVRTC_2BPPV1, EXTERNAL_NONE, TYPE_NONE), //FORMAT_RGBA_PVRTC1_16X8_UNORM,
        new Format(INTERNAL_SRGB_ALPHA_PVRTC_4BPPV1, EXTERNAL_NONE, TYPE_NONE), //FORMAT_RGBA_PVRTC1_16X8_SRGB,
        new Format(INTERNAL_RGBA_PVRTC_4BPPV2, EXTERNAL_NONE, TYPE_NONE), //FORMAT_RGBA_PVRTC2_4X4_UNORM,
        new Format(INTERNAL_SRGB_ALPHA_PVRTC_4BPPV2, EXTERNAL_NONE, TYPE_NONE), //FORMAT_RGBA_PVRTC2_4X4_SRGB,
        new Format(INTERNAL_RGBA_PVRTC_2BPPV2, EXTERNAL_NONE, TYPE_NONE), //FORMAT_RGBA_PVRTC2_8X4_UNORM,
        new Format(INTERNAL_SRGB_ALPHA_PVRTC_2BPPV2, EXTERNAL_NONE, TYPE_NONE), //FORMAT_RGBA_PVRTC2_8X4_SRGB,

        new Format(INTERNAL_RGB_ETC, EXTERNAL_NONE, TYPE_NONE), //FORMAT_RGB_ETC_UNORM,
        new Format(INTERNAL_ATC_RGB, EXTERNAL_NONE, TYPE_NONE), //FORMAT_RGB_ATC_UNORM,
