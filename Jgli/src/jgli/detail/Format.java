...
public class Format {
    ...
    private static final FormatInfo[] table = new FormatInfo[]{
        ...
        new FormatInfo((byte) 2, new int[]{1, 1, 1}, (byte) 2, (short) (CAP_NORMALIZED_BIT | CAP_UNSIGNED_BIT)), //FORMAT_RG8_UNORM,
        new FormatInfo((byte) 3, new int[]{1, 1, 1}, (byte) 3, (short) (CAP_NORMALIZED_BIT | CAP_UNSIGNED_BIT)), //FORMAT_RGB8_UNORM,
        new FormatInfo((byte) 4, new int[]{1, 1, 1}, (byte) 4, (short) (CAP_NORMALIZED_BIT | CAP_UNSIGNED_BIT)), //FORMAT_RGBA8_UNORM,

        new FormatInfo((byte) 2, new int[]{1, 1, 1}, (byte) 1, (short) (CAP_NORMALIZED_BIT | CAP_UNSIGNED_BIT)), //FORMAT_R16_SNORM,
        new FormatInfo((byte) 4, new int[]{1, 1, 1}, (byte) 2, (short) (CAP_NORMALIZED_BIT | CAP_UNSIGNED_BIT)), //FORMAT_RG16_SNORM,
        new FormatInfo((byte) 6, new int[]{1, 1, 1}, (byte) 3, (short) (CAP_NORMALIZED_BIT | CAP_UNSIGNED_BIT)), //FORMAT_RGB16_SNORM,
        new FormatInfo((byte) 8, new int[]{1, 1, 1}, (byte) 4, (short) (CAP_NORMALIZED_BIT | CAP_UNSIGNED_BIT)), //FORMAT_RGBA16_SNORM,
